                    ...
                    <ul className="pt-1 pb-2 px-3 overflow-y-auto">
                      <li className="mt-2">
                        ...
                        >
                          ...
                          >
                            <span>Forest Conservation Organisation</span>
                        ...
                        >
                          <div
                            className="flex items-center justify-between
									font-semibold capitalize dark:text-gray-700"
                          >
                            <span>women Environmental Movement</span>
                ...
                <div className="flex top-4 w-80 right-4 bg-white p-4 rounded-lg shadow-md mt-50">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <small>
                        <span className="font-italic">NB:</span> Price of 1
                        CARBZ is equal to 0.1 cUSD
                      </small>
                      <div className="flex space-x-1">
